...
trainset = DermaMNIST(split="train", transform=transform_train, download=download, size=224)
testset = DermaMNIST(split="test", transform=transform_test, download=download, size=224)
